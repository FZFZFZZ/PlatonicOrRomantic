...
if __name__ == '__main__':
    ...
    dialogues = [
        [{'role': 'B', 'response': "Hey Mei Ling, would you like to join me for dinner tonight? Let's chat more in person!"}, {'role': 'A', 'response': "That sounds great! I'd love to catch up and talk more. Where shall we meet?"}, {'role': 'B', 'response': 'How about the café near campus at 7 PM? Looking forward to it!'}, {'role': 'A', 'response': "Perfect! See you there. Can't wait to hear about your day."}, {'role': 'B', 'response': "I can't wait either! It's been quite a creative day for me."}, {'role': 'A', 'response': "Sounds exciting! Let's dive into all the details when we meet."}, {'role': 'B', 'response': "Definitely, can't wait to see you. I have a lot to share!"}, {'role': 'A', 'response': "I'm looking forward to exchanging our stories. See you soon, Min-joon!"}, {'role': 'B', 'response': 'See you soon, Mei Ling! Really excited for tonight.'}, {'role': 'A', 'response': "I am too! Let's make it a memorable evening."}, {'role': 'B', 'response': "Absolutely, I promise it'll be unforgettable."}, {'role': 'A', 'response': "Let's create amazing memories together!"}, {'role': 'B', 'response': 'Looking forward to every moment with you.'}, {'role': 'A', 'response': 'Excited for our stories, see you tonight!'}, {'role': 'B', 'response': "Can't wait, Mei Ling. See you later!"}, {'role': 'A', 'response': 'Counting the minutes till then!'}, {'role': 'B', 'response': '$S$'}, {'role': 'A', 'response': 'Me too! Your energy is contagious.'}, {'role': 'B', 'response': '$S$'}, {'role': 'A', 'response': "Can't wait for more creative chats later."}],
    ]
